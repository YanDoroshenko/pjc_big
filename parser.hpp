...
void parse_vector(std::vector<std::string>*, std::vector<std::string>*, mode, std::mutex*); // parse an process a vector of strings and write results into the other vector
